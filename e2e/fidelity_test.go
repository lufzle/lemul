...
// These are the section 4.1 requirements, ported from the S3 prototype
// (tui-proxy-proto/fidelity_test.go) onto the runner/supervisor split. S3 has
// already proved the transport does not degrade fidelity; the job here is to
// prove the split did not either.
