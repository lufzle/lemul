...
//
// The screen-correctness half of this was measured separately by replaying the
// SIGWINCH nudge output into a fresh VT emulator. What this adds is that the
// mechanism survives the full split path.
