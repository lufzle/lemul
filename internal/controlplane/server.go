...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /v1/workspaces/{wid}/fs", protect(s.handleListDir))
	mux.HandleFunc("GET /v1/workspaces/{wid}/processes", protect(s.handleListProcesses))
	mux.HandleFunc("GET /v1/workspaces/{wid}/resources", protect(s.handleResources))
