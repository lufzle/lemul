...
func (s *Server) askWorkspace(w http.ResponseWriter, wid, verb string, req any, out any) bool {
...
func (s *Server) handleListDir(w http.ResponseWriter, r *http.Request) {
	...
	if !s.askWorkspace(w, r.PathValue("wid"), tunnel.MsgListDir, req, &listing) {
		return
	}
...
func (s *Server) handleListProcesses(w http.ResponseWriter, r *http.Request) {
	...
	if !s.askWorkspace(w, r.PathValue("wid"), tunnel.MsgListProcesses, nil, &list) {
		return
	}
...
func (s *Server) handleResources(w http.ResponseWriter, r *http.Request) {
	...
	if !s.askWorkspace(w, r.PathValue("wid"), tunnel.MsgResources, nil, &usage) {
		return
	}
